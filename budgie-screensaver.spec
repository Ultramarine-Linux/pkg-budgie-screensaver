...
%description
budgie-screensaver is a screen saver and locker that aims to have
...
%install
%make_install
# autostart now included in gnome-flashback
rm -f %{buildroot}/%{_sysconfdir}/xdg/autostart/gnome-screensaver.desktop

%find_lang budgie-screensaver

%files -f budgie-screensaver.lang
...
* Wed Oct 28 2020 Thomas Batten <stenstorpmc@gmail.com> - 3.6.1-27
- Adapt to budgie-screensaver
- Apply patches from https://github.com/getsolus/budgie-screensaver
- Remove duplicated patch 101

* Thu Jan 16 2020 Yaakov Selkowitz <yselkowi@redhat.com> - 3.6.1-26
- Fix build for libgnome-desktop 3.35.4

* Thu Jul 25 2019 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.1-25
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Sun Jul 21 2019 Kalev Lember <klember@redhat.com> - 3.6.1-24
- Rebuilt for libgnome-desktop soname bump

* Thu Jun 20 2019 Adam Jackson <ajax@redhat.com> - 3.6.1-23
- Drop BuildRequires: libXxf86misc-devel, X servers haven't implemented that
  extension in 10+ years.

* Thu Jan 31 2019 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.1-22
- Rebuilt for https://fedoraproject.org/wiki/Fedora_30_Mass_Rebuild

* Fri Jul 13 2018 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.1-21
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Sun Feb 18 2018 Yaakov Selkowitz <yselkowi@redhat.com> - 3.6.1-20
- Rebuilt for gnome-desktop3 3.28

* Wed Feb 07 2018 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.1-19
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Wed Aug 02 2017 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.1-18
...
* Wed Feb 03 2016 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.1-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_24_Mass_Rebuild

* Fri Oct 02 2015 Yaakov Selkowitz <yselkowi@redhat.com> - 3.6.1-14
- Remove autostart entry

* Thu Jul 23 2015 Adam Williamson <awilliam@redhat.com> - 3.6.1-13
- rebuild for new gnome-desktop

* Fri Jul 17 2015 Yaakov Selkowitz <yselkowi@redhat.com> - 3.6.1-12
- Fix SIGSEGV in gs_fade_reset (#1244084)

* Tue Jul 14 2015 Yaakov Selkowitz <yselkowi@redhat.com> - 3.6.1-11
